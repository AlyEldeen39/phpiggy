    ...
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('email', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['email'] as $e) echo e($e) . "<br>" ?>
                </div>
            <?php endif ?>
        </label>
        <!-- Age -->
        <label class="block">
            ...
            <?php if (array_key_exists('age', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['age'] as $e) echo e($e) . "<br>" ?>
                </div>
            <?php endif ?>
        </label>
        <!-- Country -->
        <label class="block">
            ...
            <?php if (array_key_exists('country', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['country'] as $e) echo e($e) . "<br>" ?>
                </div>
            <?php endif ?>
        </label>
        <!-- Social Media URL -->
        <label class="block">
            ...
            <?php if (array_key_exists('socialMediaURL', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['socialMediaURL'] as $e) echo e($e) . "<br>" ?>
                </div>
            <?php endif ?>
        </label>
        <!-- Password -->
        <label class="block">
            ...
            <?php if (array_key_exists('password', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['password'] as $e) echo e($e) . "<br>" ?>
                </div>
            <?php endif ?>
        </label>
        <!-- Confirm Password -->
        <label class="block">
            ...
            <?php if (array_key_exists('confirmPassword', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php foreach ($errors['confirmPassword'] as $e) echo e($e) . "<br>" ?>
                </div>
            <?php endif ?>
        </label>
        <!-- Terms of Service -->
            ...
            <div class="mt-2">
                <div>
                    ...
                    <?php if (array_key_exists('tos', $errors)) : ?>
                        <div class="bg-gray-100 mt-2 p-2 text-red-500">
                            <?php foreach ($errors['tos'] as $e) echo e($e) . "<br>" ?>
                        </div>
                    <?php endif ?>
                </div>
            </div>
